...
import com.voice.book.util.FucUtil;
import com.voice.book.util.JsonParser;
...
public class VoiceActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		SpeechUtility.createUtility(this, "appid=" + "5e9b4832");
...
//		languageValues = getResources().getStringArray(R.array.iat_language_value);
	...
	private void initLayout() {
		findViewById(R.id.iat_recognize).setOnClickListener(VoiceActivity.this);
		findViewById(R.id.iat_recognize_stream).setOnClickListener(VoiceActivity.this);
		findViewById(R.id.iat_upload_contacts).setOnClickListener(VoiceActivity.this);
		findViewById(R.id.iat_upload_userwords).setOnClickListener(VoiceActivity.this);
		findViewById(R.id.iat_stop).setOnClickListener(VoiceActivity.this);
		findViewById(R.id.iat_cancel).setOnClickListener(VoiceActivity.this);
		findViewById(R.id.image_iat_set).setOnClickListener(VoiceActivity.this);
		findViewById(R.id.languageText).setOnClickListener(VoiceActivity.this);
	}
...
//			Intent intents = new Intent(VoiceActivity.this, IatSettings.class);
//			startActivity(intents);
		...
		case R.id.iat_upload_contacts:
			...
			ContactManager mgr = ContactManager.createManager(VoiceActivity.this,
					mContactListener);
...
//			String contents = FucUtil.readFile(VoiceActivity.this, "userwords","utf-8");
